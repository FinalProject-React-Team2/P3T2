    ...
    return (
        <div>
            <div className="header-content">
                ...
                <a href="http://localhost:3000/Dashboard" className="btn btn-primary btn-lg">DEBATE NOW</a>
            </div>
        ...
        <section className="content content-3">
            <div className="container">
                <h2 className="section-header">Donate Here!</h2>
                    <p className="lead text-muted">Testing for more details stay tune later</p>
                    <a href="#" className="btn btn-primary btn-lg">Donate Test Button</a>
            </div>
        </section>
        </div>
